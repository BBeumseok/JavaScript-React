...
const numbers = {
  ...
  b: 2,
  get sum() {
    //  Getter 함수 - 특정 값을 조회 시 설정한 함수로 연산된 결과 반환
    console.log('sum 함수를 실행합니다.');
    return this.a + this.b;
  },
};
// 객체 내에 선언된 값은 고정되는 것이 아닌, 값의 위치를 저장하는 것.
// numbers.a = 5;
console.log(numbers);
...
//  getter / setter를 사용하는 것만으로도 값을 불러올 수 있다.
