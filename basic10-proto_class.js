...
//  객체 생성자...  객체 생성자는 함수를 통해 새로운 객체를 만들고, 그 안에 넣고싶은 함수들을 구현할 수 있게
//  만들어준다.
...
const cat2 = new Cat('야오이', '야옹');
dog2.say();
cat2.say();

//  클래스
//  ES5 이전에는 클래스 문법이 없었기 때문에 위에서처럼 객체 생성자 함수를 이용했다.
//  ES6 에서부터 class라는 문법이 추가되었음.
class AnimalClass {
